function start()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/XrrKZjkFL/model.json', modelReady);
...
{ 
  ...
  else
  {
       ...
       {
           img1.src = 'cool-cat-animated-gif-9.gif'
       }
